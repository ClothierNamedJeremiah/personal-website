...
const PROJECTS = [
  {
    ...
    tags: ['Axios', 'React', 'LESS', 'Node', 'Express', 'Figma'],
  ...
  },
  {
    ...
    description: 'I wanted to help educate students and show people how they could be saving money on their loans. I created and deployed a web application to AWS that shows students how much they could be saving over the liftime of their student loans. Users submit their data in seconds and get instant results.',
